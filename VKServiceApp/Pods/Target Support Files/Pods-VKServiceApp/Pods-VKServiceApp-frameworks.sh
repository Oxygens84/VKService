...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftKeychainWrapper-iOS11.2/SwiftKeychainWrapper.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftKeychainWrapper-iOS12.0/SwiftKeychainWrapper.framework"
