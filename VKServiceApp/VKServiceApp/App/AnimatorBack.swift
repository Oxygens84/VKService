        ...
        UIView
            .animate(withDuration: self.transitionDuration(using: transitionContext),
                     animations: {
                        ...
                        UIView.setAnimationTransition(UIView.AnimationTransition.flipFromLeft, for: source.view, cache: false)
                        
            }) { finished in
                UIView.setAnimationTransition(UIView.AnimationTransition.flipFromLeft, for: destination.view, cache: false)
